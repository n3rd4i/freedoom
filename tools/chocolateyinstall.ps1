...
$url        = 'https://github.com/freedoom/freedoom/releases/download/v0.11.3/freedoom-0.11.3.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'freedoom*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
